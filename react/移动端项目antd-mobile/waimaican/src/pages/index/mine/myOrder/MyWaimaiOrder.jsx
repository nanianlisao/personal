...
export default class MyOrder extends React.Component {
    ...
    async loadOrders() {
        ...
        try {
            let res = await Axios.get('order/pay/list/my/take/out', {
                states: '2', // 已完成的订单
            ...
            data.map(order => {
                order.orderQueryVos[0].actualPayment = Number(order.orderQueryVos[0].amount - order.orderQueryVos[0].allDiscounts).toFixed(2)
            })
            this.setState({
            ...
            return (
                <div className='order-item' key={index} onClick={() => {
                    ...
                    <div className='goods-list'>
                        ...
                        {/* <div className='order-status'>{item.state == 2 ? '订单准备中' : '订单已完成'}</div> */}
                    </div>
                    <div className='flex-middle'>
