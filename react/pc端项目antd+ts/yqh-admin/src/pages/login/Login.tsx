...
export default class Login extends React.Component<ILoginProps, ILoginState> {
    ...
    public userNameRef: InputCom | null = null
    public passWordRef: InputCom | null = null
    ...
    public render() {
        return (
            <Layout style={{
                ...
                <Content>
                    <div className='pos-center' style={loginBoxStyle}>
                        <div>
                            <InputCom
